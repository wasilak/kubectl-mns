...
Plans:
- [x] 01-01-PLAN.md — Plugin hardening: array quoting, array exec, -n check, stderr, typo, exit 1 (SAFETY-01..03, BUGFIX-02..04)
- [x] 01-02-PLAN.md — README fix: remove redundant kubectl after -- (BUGFIX-01)
- [x] 01-03-PLAN.md — CI security: pin Codacy action to commit SHA (SECURITY-01)
